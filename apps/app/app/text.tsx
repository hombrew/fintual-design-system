      ...
      >
        ...
        <View className="native:pb-12 max-w-lg">
          ...
          <Typography variant="p">
            ...
            . The flower had the power to make the forest come alive with
            vibrant colors and happy creatures.
          </Typography>
          ...
          <Typography variant="p">
            ...
            feast. They gathered nuts, berries, and fruits from the colorful
            trees and shared stories of their adventures. The joyous laughter
            echoed through the Rainbow Forest.
          </Typography>
          <View className="p-1.5" />
          ...
          <Typography variant="p">
            ...
            parts of the world. Soon, forests everywhere became vibrant and
            alive, thanks to the discovery of Whiskers and the enchanted Rainbow
            Forest.
          </Typography>
          <View className="p-1.5" />
